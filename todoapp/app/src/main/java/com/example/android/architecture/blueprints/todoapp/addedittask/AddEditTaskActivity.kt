...
class AddEditTaskActivity : AppCompatActivity(), AddEditTaskNavigator {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel = findOrCreateViewModel().also {
            ...
            addEditTaskFragment.setViewModel(it)
    ...
    companion object {
        @JvmField val REQUEST_CODE = 1
        @JvmField val ADD_EDIT_RESULT_OK = Activity.RESULT_FIRST_USER + 1
        @JvmField val ADD_EDIT_VIEWMODEL_TAG = "ADD_EDIT_VIEWMODEL_TAG"
    }
}